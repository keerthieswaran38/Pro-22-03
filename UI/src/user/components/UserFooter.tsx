        ...
        <div className="footer-top">
            <div className="footer-col footer-about">
                ...
                <div className="social-links">
                    <a href="https://www.facebook.com/gagnersportsandevents" className="social-icon hover-target" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    <a href="https://www.instagram.com/gagnersports" className="social-icon hover-target" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    ...
                    <a href="https://www.youtube.com/@gagnersports" className="social-icon hover-target" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                    ...
                    <a href="https://wa.me/+919840547782" className="social-icon hover-target" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
            ...
            <div className="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="/#blogs" className="hover-target">Blogs</a></li>
                </ul>
            </div>
            <div className="footer-col">
                <h4>POLICIES</h4>
                <ul>
                    <li><Link to="/privacy-policy" className="hover-target">Privacy Policy</Link></li>
                    <li><Link to="/terms-conditions" className="hover-target">Terms & Conditions</Link></li>
                    <li><Link to="/refund-cancellation" className="hover-target">Refund & Cancellation</Link></li>
                </ul>
            </div>
